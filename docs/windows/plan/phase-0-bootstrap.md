...
3. **Code-signing certificate**: tracked as [GitHub issue #1](https://github.com/JRub19/CodexBar4Windows/issues/1). Decision needed before Phase 9 (Polish, Packaging, Release). Budget around $200/yr OV, $300+/yr EV. Legal entity to be named on the cert.
